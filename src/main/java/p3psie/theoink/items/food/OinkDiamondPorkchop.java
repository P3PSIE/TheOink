...
public class OinkDiamondPorkchop extends OinkFoodBase {
    ...
    public OinkDiamondPorkchop(String name, String oreName, int hunger, float saturation, boolean isWolfFood) {
        ...
        effects = new PotionEffect[OinkConfig.FOOD.diamondPorkchopEffects.length];
        for(int i = 0; i < OinkConfig.FOOD.diamondPorkchopEffects.length; i++) {
            String[] split = OinkConfig.FOOD.diamondPorkchopEffects[i].split(",");
